  ...
  return (
    <div className="py-20 bg-[#F9FAFB] font-[Urbanist] overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        <p className="text-gray-500 max-w-2xl mx-auto text-sm md:text-base mb-16 leading-relaxed">
        ...
        <div className="relative px-4">
          {reviews && reviews.length > 0 ? (
                ...
                <SwiperSlide key={item.id || index}>
                  {({ isActive }) => (
                    <div
                      ...
                      ${isActive ? 'border-blue-400 shadow-xl scale-105 z-10' : 'border-transparent opacity-30 scale-90 grayscale'}`}
                    >
                      <div>
                      ...
                      <div className="border-t-2 border-dashed border-gray-100 pt-6 flex items-center gap-4">
                        <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center font-bold text-primary overflow-hidden shrink-0">
                          {item.user_photoURL ? (
                            <img
            ...
            <div className="py-20 text-gray-400">Loading reviews...</div>
          )}
